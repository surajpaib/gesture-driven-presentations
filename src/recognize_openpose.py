    ...
    while(True):
        ...
        if keypoints is not None:
            ...
            if (r_wrist[2] > 0.3) and (l_wrist[2] > 0.3):
                ...
                cv2.circle(frame, (keypoints[2][0], keypoints[2][1]), 10, (0,255,0), -1)
                cv2.circle(frame, (keypoints[4][0], keypoints[4][1]), 10, (0,0,255), -1)

                # Left wrist: open/previous slide.
                if(l_wrist_x_old - l_wrist_x > 70):
